...
ROBOT_LEFT_TURN_RADIUS = 0.01 * SCALING_FACTOR
ROBOT_RIGHT_TURN_RADIUS = 0.01 * SCALING_FACTOR
...
PATH_TURN_COST = 999 * ROBOT_SPEED_PER_SECOND * ROBOT_RIGHT_TURN_RADIUS
